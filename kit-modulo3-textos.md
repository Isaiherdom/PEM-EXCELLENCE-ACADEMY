...
### ISO 9001 · Cl. 5.2–5.3 · Política, Roles y Responsabilidades · Nivel 1 Fundamentos · Escuela de Calidad
...
```
Crea una presentación ejecutiva de máximo 8 diapositivas titulada "ISO 9001 — Módulo 3: Política, Roles y Responsabilidades" para PEM Excellence Academy, la universidad corporativa de Production Enhancement México (PEM).
...
5. Ejemplo real: la cadena de autoridad ante una desviación — operador, supervisor, gerente, Responsable del SGI, Dirección.
6. Riesgo si los roles no están claros — nadie actúa a tiempo, la no conformidad se repite.
7. Tu rol — cómo cada puesto conoce su propia autoridad dentro del sistema.
8. Cierre — invitación a tomar el examen del Módulo 3 y obtener el certificado digital.

Usa imágenes de un organigrama simple estilo diagrama de flujo, un supervisor tomando una decisión en campo, y un documento de política de calidad real (sin texto legible, solo composición). Incluye "PEM Excellence Academy — Módulo 3" en la portada.
```
...
- Manómetro o pantalla de control en zona de alerta (continuidad visual con el manómetro de marca)
- Diagrama de flujo/organigrama simple, editable en Gamma
- Supervisor de campo tomando una decisión, radio o tablet en mano
- Documento de política de calidad como composición abstracta (sin texto legible)
- Iconografía lineal: contexto, objetivos, cumplimiento, comunicación (4 elementos de Cl. 5.2)

Evitar: organigramas corporativos genéricos de oficina sin relación con operación de campo.
...
```
Avatar: el mismo personaje de los Módulos 1 y 2, para mantener continuidad de identidad en la Escuela de Calidad.
...
Gestos: énfasis en el bloque "cadena de autoridad" (gesto de conteo o de pasar de mano en mano) y en el cierre.
...
**Código de documento:** PEM-ACAD-M3-KIT-01
**Escuela:** Calidad · Nivel 1 · Fundamentos
**Cláusula normativa:** ISO 9001:2015 — 5.2–5.3
