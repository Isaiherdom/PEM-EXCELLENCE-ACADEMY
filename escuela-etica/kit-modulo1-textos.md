...
### ISO 37001 · Cl. 4 · Fundamentos y Contexto del Riesgo de Soborno · Nivel 1 Fundamentos · Escuela de Ética y Cumplimiento

Primer módulo de la Escuela de Ética. Replica exactamente la estructura del Gold Standard (PEM-ACAD-GOLD-01); acento visual rojo (#E8603D), reservado para esta escuela desde la Guía de Identidad Visual.
...
Usa imágenes reales de operación petrolera, una junta de Comité de Integridad, y un mapa simple de partes interesadas. Incluye "PEM Excellence Academy — Escuela de Ética y Cumplimiento — Módulo 1" en la portada.
```
...
|---|---|---|---|
| 1 | Hook | Regalo y cena junto a una orden de compra | "'Todos hacen esto.'" |
| 2 | Contexto de riesgo | Icono de PEM rodeado de factores | "Lo que te rodea, te expone" |
| 3 | Partes interesadas | Mapa de nodos (igual a la infografía) | "SENER, clientes, proveedores" |
| 4 | Alcance del SGAS | Iconos de Compras, Ventas, RH, Finanzas | "Dónde vive el riesgo real" |
| 5 | ISO 37001 en una frase | Fondo rojo, una sola línea grande | "Anticipar, no reaccionar" |
| 6 | Sector de alto riesgo | Contrato de alto valor con autoridad | "Más contacto, más exposición" |
| 7 | Riesgo | Dos áreas con criterio distinto | "Sin contexto claro, inconsistencia" |
...
**[0:00–0:20 — Hook]**
"Un proveedor le ofreció a un colaborador de Compras una cena costosa y un regalo personal, justo antes de que se aprobara una orden de compra importante. Nadie lo reportó, porque 'todos hacen esto'. Esa frase es exactamente la señal que el contexto de riesgo de soborno de PEM tiene que identificar."

**[0:20–1:00 — Contexto de riesgo]**
...
**[2:50–3:25 — Sector de alto riesgo]**
"El sector energético tiene mayor exposición porque involucra contratos de alto valor y relación constante con autoridades regulatorias — condiciones donde una decisión individual puede tener un impacto económico real."

**[3:25–4:00 — Riesgo y cierre]**
"Cuando dos áreas de PEM entienden de forma distinta qué representa un riesgo real de soborno, se genera el mismo tipo de inconsistencia que hemos visto en otras escuelas de esta Academia. Con esto terminas el Módulo 1 de la Escuela de Ética. Toma el examen de 10 preguntas — necesitas 80% para aprobar — y genera tu certificado digital. Nos vemos en el Módulo 2."
...
```
Avatar: nuevo personaje para la Escuela de Ética (a validar si se reutiliza un avatar de otra escuela o se define uno propio — ver Gold Standard sección 1.2), profesional mexicano, 35-45 años, business casual, tono serio pero cercano, sin dramatismo.
Fondo: estudio neutro oscuro/gris grafito con acento rojo (#E8603D), coherente con el color reservado a esta escuela.
...
| Situaciones de riesgo reportadas | % de colaboradores de áreas de alto contacto (Compras, Ventas) que completan el módulo y reportan al menos una situación revisada en los 90 días posteriores | Monitoreo — tendencia creciente esperada |

---

**Código de documento:** PEM-ACAD-37001-M1-KIT-01
**Escuela:** Ética y Cumplimiento · Nivel 1 · Fundamentos
**Cláusula normativa:** ISO 37001:2025 — 4
