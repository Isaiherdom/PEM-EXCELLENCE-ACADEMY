...
### ISO 9001 · Cl. 6.2–6.3 · Objetivos de Calidad y Planificación de Cambios · Nivel 2 Intermedio · Escuela de Calidad
...
```
Crea una presentación ejecutiva de máximo 8 diapositivas titulada "ISO 9001 — Módulo 5: Objetivos de Calidad y Planificación de Cambios" para PEM Excellence Academy, la universidad corporativa de Production Enhancement México (PEM).
...
1. Hook — "'Este año queremos mejorar la calidad' no es un objetivo. Es un deseo."
2. Qué es un objetivo de calidad real en PEM — medible, no aspiracional.
...
|---|---|---|---|
| 1 | Hook | Frase tachada "mejorar la calidad" con signo de interrogación | "Eso no es un objetivo. Es un deseo." |
...
Evitar: iconografía genérica de "metas" tipo motivacional de oficina sin conexión a datos reales.
...
**[0:00–0:20 — Hook]**
"'Este año queremos mejorar la calidad.' Si eso es lo único que se dijo en la junta de planeación, no hay objetivo de calidad todavía — hay un deseo. La cláusula 6.2 de ISO 9001 pide algo mucho más concreto."
...
| Objetivos de calidad bien formulados | % de objetivos de calidad registrados en el periodo que cumplen los 5 elementos del canvas (qué/recursos/responsable/plazo/evaluación) | Monitoreo — tendencia creciente esperada tras el módulo |

---

**Código de documento:** PEM-ACAD-M5-KIT-01
**Escuela:** Calidad · Nivel 2 · Intermedio
**Cláusula normativa:** ISO 9001:2015 — 6.2–6.3
